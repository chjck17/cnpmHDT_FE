    ...
    render() {
        ...
        return (
            <div class="container rounded bg-white mt-5 mb-5">
                <div class="row">
                    <div class="col-md-7">
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg" /></div>
                        <div>aaaaa</div>
                        <div>aaaaa</div>
                    </div>
                    <div class="col-md-5">
