            ...
            <div class="container rounded bg-white mt-5 mb-5">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="col-md-12"><label class="labels">Tên Xe</label>
                                <input 
                                    type="text"
                                    class="form-control" 
                            ...
                            <div class="col-md-12"><label class="labels">Giá</label>
                            <input 
                                type="text"
                                class="form-control" 
                    ...
                    <div class="col-md-5">
                        <div class="p-3 py-5">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="text-right">THÔNG TIN ĐẶT HÀNG</h4>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-12"><label class="labels">Tên Người Nhận</label>
                                    <input 
                                        type="text"
                            ...
                            <div class="row mt-3">
                                ...
                                /></div>
                                <div class="col-md-12"><label class="labels">Địa chỉ nhận hàng</label>
                                    <input 
                                        type="text"
                                ...
                                /></div>
                                <div class="col-md-12"><label class="labels">Phương thức thanh toán</label><br/>
                                        <input 
                                            type="radio" 
                                            value= {1}
